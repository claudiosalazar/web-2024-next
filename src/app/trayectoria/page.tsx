  ...
  return (
    <section className="info-trayectoria trayectoria row d-flex align-items-center">
      <div className="col-5 offset-1">
        ...
        <a className="botonCv contenedor-btn-cv my-4 mt-lg-5 mt-xl-5">
          <p className="ms-md-5 ms-lg-4 ms-xl-0 resumen">
            <a href="/claudio-salazar-cv2024.pdf" target="_blank" className="curriculum d-flex align-items-center">

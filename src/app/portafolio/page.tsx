    ...
    <>
      <section className="info-portafolio portafolio row d-flex align-items-center pt-5">
        <motion.div
          ...
          className='titulo col-12 col-md-12 col-xl-10 mx-auto text-center pt-4 '
        >
        ...
        <motion.div
          variants={contenidoPortafolio}
          initial='hidden'
          animate={controlContenido}
          className='contenidoPortafolio col-12 col-md-12 col-xl-10 mx-auto pt-5'
        >
          {activeSection === 0 && (
            <motion.div 
              initial={{ opacity: 0 }}
